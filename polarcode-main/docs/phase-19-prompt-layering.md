...
```text
src/main/java/com/polarcode/prompt/
...
2. 用户级覆盖：`~/.polarcode/prompts/...`
3. 项目级覆盖：`.polarcode/prompts/...`

例如：

```text
~/.polarcode/prompts/base.md
~/.polarcode/prompts/modes/agent.md
.polarcode/prompts/modes/team-worker.md
```
...
- [x] 支持用户级覆盖 `~/.polarcode/prompts/...`
- [x] 支持项目级覆盖 `.polarcode/prompts/...`
- [x] 校验 `## Language`
- [x] ReAct 接入
