...
新增包：`src/main/java/com/polarcode/snapshot/`
...
```text
~/.polarcode/snapshots/<project_hash>/<worktree_hash>/.git
```
...
```bash
-Dpolarcode.snapshot.enabled=false
-Dpolarcode.snapshot.max=50
-Dpolarcode.snapshot.excludes=...
```
