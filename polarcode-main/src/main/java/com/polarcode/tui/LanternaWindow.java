...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(PolarCodeConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("PolarCode v16.0.0");
    ...
    public PolarCodeConfig getConfig() {
        return config;
    }
}
