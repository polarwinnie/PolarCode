...
import com.polarcode.tui.history.ConversationSnapshot;
import com.polarcode.tui.pane.CenterPane;
import com.polarcode.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final PolarCodeConfig config;
    ...
    public TuiSessionController(PolarCodeConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "polarcode-tui-agent-runner");
