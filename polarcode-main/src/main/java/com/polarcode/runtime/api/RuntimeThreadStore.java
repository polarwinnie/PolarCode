...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("polarcode.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("POLARCODE_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".polarcode", "runtime").toString();
        }
