...
public class AgentOrchestrator {
     ...
     */
    public void setSkillSystem(com.polarcode.skill.SkillRegistry skillRegistry,
                               com.polarcode.skill.SkillContextBuffer skillContextBuffer) {
    ...
    private void runBatchParallel(List<ExecutionStep> batch, List<ExecutionStep> steps,
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread t = new Thread(r, "polarcode-multi-agent");
            t.setDaemon(true);
            return t;
        });
