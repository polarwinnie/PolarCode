...
public final class AnsiStyle {
    ...
    // 256-color tokens for the polar bear banner
    private static final String BEAR_FUR = "\u001B[38;5;255m";      // 亮白
    private static final String BEAR_INNER_EAR = "\u001B[38;5;218m"; // 粉
    private static final String BEAR_SCARF = "\u001B[38;5;196m";    // 红
    private static final String BEAR_EYE = "\u001B[38;5;236m";      // 深灰黑
    private static final String BEAR_NOSE = "\u001B[38;5;52m";      // 棕黑
    private static final String BEAR_OUTLINE = "\u001B[38;5;240m";  // 灰描边
    ...
    public static String polarBlue(String text) {
    ...
    // === 北极熊 banner 专用色（256-color） ===

    public static String bearFur(String text) {
        return wrap(BEAR_FUR + BOLD, text);
    }

    public static String bearInnerEar(String text) {
        return wrap(BEAR_INNER_EAR, text);
    }

    public static String bearScarf(String text) {
        return wrap(BEAR_SCARF + BOLD, text);
    }

    public static String bearEye(String text) {
        return wrap(BEAR_EYE, text);
    }

    public static String bearNose(String text) {
        return wrap(BEAR_NOSE, text);
    }

    public static String bearOutline(String text) {
        return wrap(BEAR_OUTLINE, text);
    }
    ...
    private static boolean determineEnabled() {
        String property = System.getProperty("polarcode.render.color");
