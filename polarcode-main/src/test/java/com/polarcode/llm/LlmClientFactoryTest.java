...
class LlmClientFactoryTest {
    ...
    void createsGlm5vTurboClientWithMultimodalEndpoint() {
        PolarCodeConfig config = new PolarCodeConfig();
        config.getProviders().put("glm",
                new PolarCodeConfig.ProviderConfig("test-glm-key", null, "glm-5v-turbo"));
    ...
    void createsStepClientFromConfiguredProvider() {
        ...
        config.getProviders().put("step",
                new PolarCodeConfig.ProviderConfig("test-step-key", null, "step-3.5-flash-2603"));
    ...
    void createsStepClientFromStepfunAliasAndCustomBaseUrl() {
        ...
        config.getProviders().put("step",
                new PolarCodeConfig.ProviderConfig(
                        "test-step-key",
    ...
    void returnsNullForUnknownProvider() {
        PolarCodeConfig config = new PolarCodeConfig();
        config.getProviders().put("unknown", new PolarCodeConfig.ProviderConfig("test-key", null, "unknown-model"));
