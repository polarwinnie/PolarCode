...
class PolarCodeCompleterTest {

    @Test
    void suggestsSlashCommandsWhenInputStartsWithSlash() {
        PolarCodeCompleter completer = new PolarCodeCompleter(List::of);
    ...
    void completesSkillNames() {
        PolarCodeCompleter completer = new PolarCodeCompleter(List::of, () -> List.of(
