...
class CodeRetrieverTest {
    ...
    private static final String TEST_PROJECT = "/tmp/polarcode-code-retriever";
    private VectorStore store;

    @BeforeEach
    void setUp() throws Exception {
        System.setProperty("polarcode.rag.dir", "/tmp/polarcode-test-rag-retriever");
