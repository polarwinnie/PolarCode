...
import com.polarcode.llm.GLMClient;
...
class AgentMemoryHintTest {
    ...
    void explicitChromeRememberRequestStoresSitePreferenceInLongTermMemory() {
        String oldMemoryDir = System.getProperty("polarcode.memory.dir");
        System.setProperty("polarcode.memory.dir", tempDir.toString());
        try {
            ...
            if (oldMemoryDir == null) {
                System.clearProperty("polarcode.memory.dir");
            } else {
                System.setProperty("polarcode.memory.dir", oldMemoryDir);
            }
        }
    }
